...
\subsection{ Sciezki bez niedokldanosci (bez least squares) }
\subsection{ Newton wzgl liczby iteracji }
\subsection{ Newton vs Algebraic vs Bancroft }
Trzeba pokazac jak dokladne sa, jezeli wgl trafia w dobre rozwiazanie.
Potem pokazac, ze niestety nie zawsze trafiaja.
Potem policzyc ile razy mniej wiecej sie myla.
Moze jeszcze pokombinowac cos z kryterium wyboru rozwiazania w metodach algebraicznych?
\subsection{ Blad zegara }
To powinno jakos naturalnie wyniknac z wyzszych doswiadczen, tzn. powinno dac sie zauwazyc, ze jest taki problem,
a tutaj sie do niego odniesiemy.
\subsection{ Coś o prawdziwych danych (niedokladnosc) }
Trzeba pokazac, ze jest taki problem i te metody co mamy sobie z nim nie radza.
Moze sciezki z niedokladnoscia zadzialaja?
...
Kolejny problem pojawia się, gdy porzucimy model teoretyczny i spróbujemy zasotosować metody w praktyce.
...
W praktyce odbiornik ma z reguły dostęp do większej niż cztery liczby satelit.
...
istotny będzie wybór przybliżenia początkowego. Aby otrzymać jak najlepsze wyniki, zastosujemy metodę wieloktornie,
...
Tutaj juz wszystko normalnie leci: sciezki, zaleznosc od liczby satelit, polozenia satelit itd itd
