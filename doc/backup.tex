...
Przedstawimy wynik przykładowych obliczeń, aby poznać przybliżone własności opisanych metod. Przyjmiemy, że
satelity w momencie nadania sygnału znajdowały się w następujących pozycjach
\begin{align*}
    s_1 &= (10720.8, 7652.89, -15049.9) \\
    s_2 &= (-11051.0, 4975.64, 15909.7) \\
    s_3 &= (2960.56, 10492.8, 16767.1) \\
    s_4 &= (-17636.8, 1421.36, 9323.16)
\end{align*}
Następnie wybierzemy 5 konkretnych punktów $x_i$
\begin{align*}
    x_1 &= (6370, 0, 0) \quad (\textrm{punkt na równiku}) \\
    x_2 &= (0, 6370, 0) \quad (\textrm{biegun północny}) \\
    x_3 &= (0, 0, 6370) \quad (\textrm{punkt na równiku}) \\
    x_4 &= (0, -6370, 0) \quad (\textrm{biegun południowy}) \\
    x_5 &= (-1475.33, -1465.05, -6021.12)
\end{align*}
i obliczymy dla nich czasy podróży sygnałów ze wzoru (\ref{eq:time_test}).
W całym doświadczeniu przyjmiemy, że błąd zegara odbiornika wynosi $0.005s$.

Wprowadźmy następujące oznaczenia
\begin{itemize}
    \item $x_{n, i}$ -- wynik działania metody Newtona (15 iteracji) dla punktu $x_i$;
    \item $x_{a, i}$ -- wynik działania metody algebraicznej dla punktu $x_i$;
    \item $x_{b, i}$ -- wynik działania metody Bancrofta dla punktu $x_i$.
\end{itemize}
Wszystkie wyniki dotyczą satelit w pozycjach $s_1, s_2, s_3, s_4$.

\begin{table}[H]
\centering
\begin{tabular}{ r || l | l | l }
    $i$   & $||x-x_{n,i}||$ & $||x-x_{a,i}||$ & $||x-x_{b,i}||$ \\ \hline
    1    & 5.56...e-10 & 1.60...e-9  & 3.75...e-10       \\
    2    & 1.50...e-10  &  3.29...e-10 & 1.48...e-9        \\
    3    & 1477.89... & 1477.89...  &  1477.89...     \\
    4    & 2.25...e-11  &  2.41...e-10 &  1.79...e-9     \\
    5    & 5.32...e-10  &  1.59...e-9 &   2.67...e-9      \\
\end{tabular}
\caption{Błąd wyniku metod dla wybranych punktów $x_i$.} \label{table:1}
\end{table}

\subsection{Liczba iteracji w metodzie Newtona}
Wyniki przedstawiony w tabeli (\ref{table:1}) pokazują wysoką precyzję metody Newtona (powyżej połowy precyzji).
Jednak dokładność metody Newtona zależy od liczby iteracji, które zostaną wykonane. Zatem powstaje pytanie, czy
wykonując większą liczbę iteracji osiągniemy większą precyzję. Wiemy, że lokalnie metoda
jest zbieżna kwadratowo, jednak trudno oszacować jakie będzie tempo zbieżności wyników w praktyce.

Zbadamy błąd metody Newtona w zależności od liczby iteracji w punktach $x_1, x_5$.

\begin{table}[H]
\centering
\begin{tabular}{ r || l | l }
    $i$   & $||x-x_{i,1}||$ & $||x-x_{i,2}||$  \\ \hline
    1    &  1929.67... & 1272.31...     \\
    2    &  21.03... &  72.13...    \\
    3    &  0.002... & 0.25...  \\
    4    &  1.32...e-9 & 3.38...e-6   \\
    5    &  1.53...e-9  &  4.30...e-10  \\
    6    &  6.65...e-10 &  1.09...e-10   \\
    7    &  3.19...e-10 &  4.40...e-10  \\
\end{tabular}
\caption{Błąd metody Newtona w zależności od liczby iteracji.} \label{table:2}
\end{table}

Wyniki przedstawione w tabeli (\ref{table:2}) pokazują, że meotda Newtona osiąga dokładność wyższą niż połowa
prezycji po wykonaniu już ok. 7 iteracji. Wykonując dalsze iteracje nie uzyskujemy poprawy dokładności, co
można zmienić zwiększając prezycję, jednak do zastosowań praktycznych taka dokładność wystarczy w zupełności.
